...
module vert_clip_neg(
    height  = height,     //linear extrude
    left    = left,      //left side
    ...
    translate([0,-(2*(hold+hold_plus)-hold),0])
